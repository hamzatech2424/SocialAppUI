        ...
        <View style={styles.container} >
            <View style={styles.Main} >
                ...
                <View style={styles.Header} >
                    <TouchableOpacity style={{ position: "absolute", left: "10%", width: "6%", height: "50%", alignItems: "center", justifyContent: "center" }}>
                ...
                <View style={{ height: 120, width: "95%", borderWidth: 1, borderColor: "grey", alignSelf: "center", flexDirection: "row", backgroundColor: "lightgrey" }}>

                    <View style={{ height: "100%", width: "35%", alignItems: "center", justifyContent: "center" }}>

                        <View style={{ width: 100, height: 100, backgroundColor: "purple", borderRadius: 50, flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                            <Text style={{ color: "white", fontSize: 20 }}>01</Text>
                            <Text style={{ color: "white", fontSize: 15 }}>Nov</Text>
                            <Text style={{ color: "white", fontSize: 15 }}>2021</Text>
                        </View>
                    ...
                    <View style={{ width: "65%", height: "100%", flexDirection: "column" }} >
                        ...
                        <View style={{ width: "100%", height: "25%", flexDirection: "row", justifyContent: "flex-end", alignItems: "center" }}>
                            ...
                            <Icon1 name="stopwatch" size={20} color="purple" />
                        </View>
