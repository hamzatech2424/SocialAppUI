...
const JobsForView = ({navigation}) => {
 ...
 style={{height:"100%",width:"100%",justifyContent:"flex-end"}}>
   ...
   <View style={{backgroundColor:"lightgrey",width:"100%",height:"10%",flexDirection:"column",justifyContent:"center",paddingLeft:"10%",marginBottom:"0.5%"}}>
       <Text  style={{color:"purple"}}>Experienced Required</Text>
       <Text style={{color:"grey"}}>New Week 8/17 showers</Text>
   </View>

   <View style={{backgroundColor:"lightgrey",width:"100%",height:"10%",flexDirection:"column",justifyContent:"center",paddingLeft:"10%",marginBottom:"0.5%"}}>
       <Text  style={{color:"purple"}}>Job Location</Text>
       <Text style={{color:"grey"}}>New Week 8/17 showers</Text>
   </View>
...
<TouchableOpacity style={{backgroundColor:"purple",height:"80%",width:"80%",borderRadius:20,justifyContent:"center",alignItems:"center"}} ><Text style={{color:"white"}}>Post</Text></TouchableOpacity>
</View>
