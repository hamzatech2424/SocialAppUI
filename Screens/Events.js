...
const Events = () => {
 ...
 style={{height:"100%",width:"100%",justifyContent:"flex-end"}}>
       <Text style={{color:"black",marginBottom:10,marginLeft:"10%"}}>Event Name</Text>
       </ImageBackground>
   </View>
   ...
   <View style={{backgroundColor:"lightgrey",width:"100%",height:"10%",flexDirection:"column",justifyContent:"center",paddingLeft:"10%",marginBottom:"0.5%"}}>
       <Text  style={{color:"purple"}}>Event Time</Text>
       <Text style={{color:"grey"}}>New Week 8/17 showers</Text>
   </View>

   <View style={{backgroundColor:"lightgrey",width:"100%",height:"10%",flexDirection:"column",justifyContent:"center",paddingLeft:"10%",marginBottom:"0.5%"}}>
       <Text  style={{color:"purple"}}>Event Location</Text>
       <Text style={{color:"grey"}}>New Week 8/17 showers</Text>
   </View>

   <View style={{backgroundColor:"lightgrey",width:"100%",height:"10%",flexDirection:"column",justifyContent:"center",paddingLeft:"10%",marginBottom:"0.5%"}}>
       <Text  style={{color:"purple"}}>Tickets</Text>
       <Text style={{color:"grey"}}>New Week 8/17 showers</Text>
   </View>
...
<TouchableOpacity style={{backgroundColor:"purple",height:"80%",width:"80%",borderRadius:20,justifyContent:"center",alignItems:"center"}} ><Text style={{color:"white"}}>Going</Text></TouchableOpacity>
</View>
