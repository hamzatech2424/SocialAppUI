...
<TouchableOpacity style={{backgroundColor:"purple",height:"80%",width:"80%",borderRadius:20,justifyContent:"center",alignItems:"center"}} ><Text style={{color:"white"}}>Create Event</Text></TouchableOpacity>
</View>
