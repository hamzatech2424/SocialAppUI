    ...
    return (
        <View style={styles.container} >
            ...
            <View style={{width:"100%",height:"17%",flexDirection:'row'}}>
                <TouchableOpacity
                activeOpacity={0.8}
                style={{width:"30%",height:"100%",justifyContent:"center",alignItems:"center",position:"relative"}}>
                <Icon name="account-circle" size={80} color="purple"  />
                <View style={{width:20,height:20,borderRadius:10,backgroundColor:"#1673EA",position:"absolute",left:"52%",bottom:"20%"}}>
...
<View style={{width:"100%",height:"7%",marginTop:"1%",justifyContent:"center",alignItems:"center"}}>

    <TouchableOpacity activeOpacity={0.8} style={{height:"90%",width:"70%",backgroundColor:"#1673EA",justifyContent:"center",alignItems:"center",borderRadius:5}}><Text style={{color:"white"}} >Edit Profile</Text></TouchableOpacity>
...
<View style={{width:"90%",height:"9%",marginTop:"4%",justifyContent:"space-between",alignItems:"center",flexDirection:"row",alignSelf:"center"}}>
    ...
    <TouchableOpacity activeOpacity={0.8}  style={{height:"90%",width:"30%",backgroundColor:"purple",justifyContent:"center",alignItems:"center",borderRadius:5}}><Text style={{color:"white"}} >Edit Profile</Text></TouchableOpacity>
